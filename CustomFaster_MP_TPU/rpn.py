...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def filter_proposals(
        ...
        #modified block --> now the variables proposals and objectness are float32 so that they are compatible with nms_kernel
        ...
        for boxes, scores, lvl, img_shape in zip(proposals, objectness_prob, levels, image_shapes):
            ...
            #modified block --> boxes and scores are converted to float32 to avoid incompatibilities
    ...
    #modified block --> new function to calculate the class weights
    # This function calculates the class weights based on the number of samples in each class.
    ...
    #modified block --> the losses weights has been added to the function
    # This function computes the loss for the RPN head.
    def compute_loss(
        ...
        pos_weight = torch.tensor([2.0], device=device) #positive anchors have twice the weight of negative anchors
