...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(
        ...
        rpn_head=None,
        rpn_pre_nms_top_n_train=300, #modified block --> the number of train and test proposal has been reduced
        ...
        box_head=None,
        box_predictor=None,
        box_score_thresh=0.7, #modified block --> score threshold has been raised from 0.05 to 0.7
        box_nms_thresh=0.5,
